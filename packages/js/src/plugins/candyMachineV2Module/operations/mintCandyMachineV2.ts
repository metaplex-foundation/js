 ...
 * @category Types
 */
export type MintCandyMachineOperation = Operation<typeof Key,
 ...
 * @category Inputs
 */
export type MintCandyMachineBuilderParams = Omit<MintCandyMachineInput,
    'confirmOptions'> & {
 ...
 * @category Contexts
 */
export type MintCandyMachineBuilderContext = Omit<MintCandyMachineOutput,
    'response' | 'nft'>;
