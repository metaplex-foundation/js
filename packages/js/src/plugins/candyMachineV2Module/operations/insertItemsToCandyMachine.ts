...
import {CandyMachineV2, CandyMachineItem} from '../models/CandyMachine';
 ...
 * @category Types
 */
export type InsertItemsToCandyMachineOperation = Operation<typeof Key,
...
export type InsertItemsToCandyMachineInput = {
     ...
     */
    candyMachine: Pick<CandyMachineV2,
 ...
 * @category Inputs
 */
export type InsertItemsToCandyMachineBuilderParams = Omit<InsertItemsToCandyMachineInput,
    'confirmOptions'> & {
