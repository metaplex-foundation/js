...
If some of these default parameters are not suitable for your use case, you may provide them explicitly when creating the NFT. [Here is the exhaustive list of parameters](packages/js/src/plugins/nftModule/createSft.ts) accepted by the `create` method.
